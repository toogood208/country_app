...
class _$_CoatOfArms implements _CoatOfArms {
  const _$_CoatOfArms({required this.png, required this.svg});
...
abstract class _CoatOfArms implements CoatOfArms {
  const factory _CoatOfArms(
      {required final String png, required final String svg}) = _$_CoatOfArms;
