...
part of 'capital_info_model.dart';
...
class _$_CapitalInfo implements _CapitalInfo {
  const _$_CapitalInfo({final List<double> latlng = const <double>[]})
      : _latlng = latlng;
...
abstract class _CapitalInfo implements CapitalInfo {
  const factory _CapitalInfo({final List<double> latlng}) = _$_CapitalInfo;
